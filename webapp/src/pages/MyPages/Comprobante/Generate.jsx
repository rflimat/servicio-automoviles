          ...
          put(`${import.meta.env.VITE_API_URL}/comprobantes/${id}`, comprobante)
            .then((res) => {
              successSwal("comprobante", "generado").then((result) => {
                navigate(`/${searchParams.get('tipo') ? `${searchParams.get('tipo')}s` : "comprobantes"}`);
              })
            })
            .catch((err) => {
              errorSwal(err);
          ...
          >
            ...
            <div className="row">
              ...
              <div className="col-12 col-md-6 mb-3">
                ...
                {validationType.values.estado == 0 ? (
                  ...
                  <Input
                    type="text"
                    value={validationType.values.estado == 1 && "Cancelado"}
                    placeholder="Seleccione estado"
                    readOnly
                  />
                )}
            ...
            <div className="d-flex flex-wrap gap-2">
              ...
              <Button
                type="reset"
                color="secondary"
                onClick={() => navigate(`/${searchParams.get('tipo') ? `${searchParams.get('tipo')}s` : "comprobantes"}`)}
              >
                Cancelar
              </Button>
            </div>
